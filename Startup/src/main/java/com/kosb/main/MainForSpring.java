...
import com.kosb.chap1.MemberListPrinter;
...
import com.kosb.chap1.VersionPrinter;
...
public class MainForSpring {
	...
	public static void main(String[] args) throws IOException {
		...
		String [] config = {"classpath:conf1.xml","classpath:conf2.xml"};
		ctx = new GenericXmlApplicationContext("classpath:conf1.xml");
